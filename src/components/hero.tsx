    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#0a0c10]">
      ...
      <div className="container mx-auto px-4 text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <Button size="lg" variant="outline" className="h-14 px-10 rounded-full text-lg font-extrabold border-white/10 hover:bg-white/5 backdrop-blur-sm transition-all">
            Book a Demo
          </Button>
        </div>
        ...
        <div className="mt-24 flex flex-wrap justify-center gap-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-700 fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-black uppercase tracking-[0.2em]">Fortune 500 Trusted</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="h-px w-8 bg-muted-foreground/30" />
            <span className="text-xs font-black uppercase tracking-[0.2em]">ISO 27001 Certified</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="h-px w-8 bg-muted-foreground/30" />
            <span className="text-xs font-black uppercase tracking-[0.2em]">Global 24/7 Support</span>
          </div>
        </div>
      </div>
    </section>
