        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-white">all9s <span className="text-primary">Solutions</span></span>
            </Link>
            ...
            <div className="flex gap-4">
              <Link href="#" className="p-2 bg-secondary/50 rounded-lg hover:bg-primary/20 hover:text-primary transition-colors">
